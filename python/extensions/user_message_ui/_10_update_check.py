...
# check for newer versions of Korev Oracle available and send notification
...
class UpdateCheck(Extension):
    ...
    def send_notification(self, notif):
        ...
        notifs.send_notification(
            ...
            message=notif.get("message", "A newer version of Korev Oracle is available. Please update to the latest version."),
