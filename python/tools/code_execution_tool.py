...
from python.helpers.path_aliases import normalize_legacy_paths_in_code
...
class CodeExecution(Tool):
    ...
    async def execute_python_code(self, session: int, code: str, reset: bool = False):
        # Normalize legacy absolute paths generated by old prompts/history.
        # Prevents FileNotFoundError like /korev/tmp/... on /app-based runtime.
        code = normalize_legacy_paths_in_code(code)
