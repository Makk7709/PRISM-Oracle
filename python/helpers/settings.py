...
def convert_out(settings: Settings) -> SettingsOutput:
    ...
    chat_model_fields.append(
        {
            ...
            "description": "Select provider for main chat model used by Korev Oracle",
            "type": "select",
    ...
    chat_model_section: SettingsSection = {
        "id": "chat_model",
        "title": "Chat Model",
        "description": "Selection and settings for main chat model used by Korev Oracle",
    ...
    auth_section: SettingsSection = {
        ...
        "description": "Settings for authentication to use Korev Oracle Web UI.",
        "fields": auth_fields,
        "tab": "external",
    }
    ...
    api_keys_section: SettingsSection = {
        "id": "api_keys",
        "title": "API Keys",
        "description": "API keys for model providers and services used by Korev Oracle. You can set multiple API keys separated by a comma (,). They will be used in round-robin fashion.<br>For more information abou Korev Oracle Venice provider, see <a href='https://korev.ai/api-dashboard' target='_blank'>Korev Oracle Venice</a>.",
    ...
    memory_fields.append(
        {
            ...
            "description": "Korev Oracle will automatically recall memories based on convesation context.",
            "type": "switch",
    ...
    mcp_client_section: SettingsSection = {
        ...
        "description": "Korev Oracle can use external MCP servers, local or remote as tools.",
   ...
   # Secrets section
    ...
    mcp_server_fields.append(
        {
            ...
            "description": "Expose Korev Oracle as an SSE/HTTP MCP server. This will make this Korev instance available to MCP clients.",
            "type": "switch",
    ...
    mcp_server_section: SettingsSection = {
        ...
        "description": "Korev Oracle can be exposed as an SSE MCP server. See <a href=\"javascript:openModal('settings/mcp/server/example.html')\">connection example</a>.",
    ...
    a2a_fields.append(
        {
            ...
            "description": "Expose Korev Oracle as A2A server. This allows other agents to connect to Korev via A2A protocol.",
            "type": "switch",
    ...
    a2a_section: SettingsSection = {
        ...
        "description": "Korev Oracle can be exposed as an A2A server. See <a href=\"javascript:openModal('settings/a2a/a2a-connection.html')\">connection example</a>.",
        "fields": a2a_fields,
        "tab": "mcp",
    }
    ...
    external_api_fields.append(
        {
            ...
            "title": "API Examples",
            "description": "View examples for using Korev Oracle's external API endpoints with API key authentication.",
            "type": "button",
    ...
    external_api_section: SettingsSection = {
        "id": "external_api",
        "title": "External API",
        "description": "Korev Oracle provides external API endpoints for integration with other applications. "
    ...
    update_checker_fields.append(
        {
            ...
            "description": "Enable update checker to notify about newer versions of Korev Oracle.",
            "type": "switch",
    ...
    backup_section: SettingsSection = {
        ...
        "description": "Backup and restore Korev Oracle data and configurations "
