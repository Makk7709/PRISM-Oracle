...
| Onboarding | `docs/ONBOARDING_AYA_30_60_90.md`, `docs/PLAN_INTEGRATION_LEAD_ENGINEER_30_60_90_INTERNAL.md`, `docs/DEVELOPER_ONBOARDING_ARCHITECTURE_GUIDE.md` | Plans d'integration 30/60/90 jours. |
| Guides operationnels | `docs/GUIDE_DEPLOIEMENT_ENTREPRISE.md`, `docs/MANUEL_INSTALLATION_CLIENT.md`, `docs/INFRA_SERVEUR_OVH.md`, `docs/GUIDE_RAPIDE_INSTALLATION.md` | Procedures de deploiement et d'installation. |
| Runbook | `deploy/RUNBOOK.md` | Procedure operationnelle de production. |
| Audit pre-deploiement | `docs/AUDIT_PRE_DEPLOIEMENT_2026-02-11.md`, `docs/AUDIT_OCR_2026-02-11.md` | Audits internes specifiques. |
