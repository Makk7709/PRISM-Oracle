...
This page addresses frequently asked questions (FAQ) and provides troubleshooting steps for common issues encountered while using Korev Oracle.

## Frequently Asked Questions
**1. How do I ask Korev Oracle to work directly on my files or dirs?**
-   Place the files/dirs in the `work_dir` directory. Korev Oracle will be able to perform tasks on them. The `work_dir` directory is located in the root directory of the Docker Container.
...
**3. How do I integrate open-source models with Korev Oracle?**
...
**10. Can Korev Oracle interact with external APIs or services (e.g., WhatsApp)?**
Extending Korev Oracle to interact with external APIs is possible by creating custom tools or solutions. Refer to the documentation on creating them. 
...
* **Performance Issues:** If Korev Oracle is slow or unresponsive, it might be due to resource limitations, network latency, or the complexity of your prompts and tasks, especially when using local models.