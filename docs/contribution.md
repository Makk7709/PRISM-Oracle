# Contributing to Korev Oracle

Contributions to improve Korev Oracle are very welcome!  This guide outlines how to contribute code, documentation, or other improvements.
...
1. **Fork the Repository:** Fork the Korev Oracle repository on GitHub.
...
* **Code Style:** Follow the existing code style. Korev Oracle generally follows PEP 8 conventions.
...
2. **Create a Pull Request:** Create a pull request from your branch to the appropriate branch in the main Korev Oracle repository.
...
- The documentation is built using Markdown. We appreciate your contributions even if you don't know Markdown, and look forward to improve Korev Oracle for everyone's benefit.