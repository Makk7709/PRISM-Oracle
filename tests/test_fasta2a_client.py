...
def print_troubleshooting():
    ...
    print("   - Make sure Korev Evidence is running: python run_ui.py")
    ...
    try:
        ...
        async with httpx.AsyncClient() as client:
            try:
                ...
                print("✅ Korev Evidence server is running")
                return True
            except httpx.ConnectError:
                print("❌ Cannot connect to Korev Evidence server")
...
def main():
    ...
    print("📋 Next Steps:")
    print("1. Start Korev Evidence server if not running")
